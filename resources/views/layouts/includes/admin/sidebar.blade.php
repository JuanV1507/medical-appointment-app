   ...
   <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default">
      ...
      <ul class="space-y-2 font-medium">
          @foreach ($links ?? [] as $link)
            <li>
               {{-- Si tiene llave o propiedad llamada header  --}}
               @isset($link['header'])
            ...
            <span class= "w-6 h-6 inline-flex items-center justify-center text-lg text-gray-500 transition duration-75 group-hover:text-gray-900">
